...
class ExportKladKasBank implements FromArray, WithStyles, WithColumnFormatting, ShouldAutoSize, WithDrawings, WithColumnWidths
{
    protected $data;
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        // Right-align numeric columns (G, H)
        $sheet->getStyle('G5:H' . $lastRow)->getAlignment()->setHorizontal(
